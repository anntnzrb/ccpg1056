...
BMP_Image *
createBMPImage(FILE *fptr);
void
readImageData(FILE *srcFile, BMP_Image *dataImage, int dataSize);
void
readImage(FILE *srcFile, BMP_Image *image);
void
writeImage(char *destFileName, BMP_Image *dataImage);
void
freeImage(BMP_Image *image);
void
transBMP(BMP_Image *image, BMP_Image *new_image);
int
